...
import com.lucas.admin.base.MySysUser;
import com.lucas.admin.entity.*;
import com.lucas.admin.util.Constants;
import com.lucas.admin.util.RestResponse;
import com.lucas.admin.util.VerifyCodeUtil;
...
//		}
	...
	public String main(Model model){
		...
		Set<com.lucas.admin.entity.Menu> menus = user.getMenus();
		java.util.List<com.lucas.admin.entity.Menu> showMenus = Lists.newArrayList();
		if(menus != null && menus.size()>0){
			for (com.lucas.admin.entity.Menu menu : menus){
...
class MenuComparator implements Comparator<com.lucas.admin.entity.Menu>{

	@Override
	public int compare(com.lucas.admin.entity.Menu o1, com.lucas.admin.entity.Menu o2) {
